-- =========================================================
-- PopPang schema (MySQL)
-- Purpose: Reproducible schema for local/dev environments
-- Notes:
--  - Removed dump metadata, session SETs, and AUTO_INCREMENT current values
--  - Keeps constraints, indexes, defaults, engine/charset/collation
-- =========================================================
...
CREATE TABLE `popup` (
                         ...
                         KEY `idx_popup_active_date` (`is_active`,`start_date`,`end_date`),
                         KEY `idx_popup_road_address` (`road_address`)
...
CREATE TABLE `popup_image` (
                               ...
                               PRIMARY KEY (`id`),
                               KEY `idx_popup_image_popup_sort` (`popup_id`,`sort_order`),
...
CREATE TABLE `user_alert` (
                              ...
                              KEY `idx_user_alerted` (`users_id`,`alerted_at`),
...
CREATE TABLE `user_favorite` (
                                 ...
                                 KEY `fk_user_favorite__user` (`users_id`),
...
CREATE TABLE `user_recommend` (
                                  ...
                                  KEY `fk_user_recommend__recommend` (`recommend_id`),
