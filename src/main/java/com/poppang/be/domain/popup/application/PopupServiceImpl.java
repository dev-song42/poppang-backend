...
public class PopupServiceImpl implements PopupService {
      ...
      try {
        List<String> districts =
            objectMapper.readValue(
                regionDistrictsRaw.getDistricts(), new TypeReference<List<String>>() {});

        RegionDistrictsResponse regionDistrictsResponse =
            RegionDistrictsResponse.builder()
  ...
  public List<PopupResponseDto> getFilteredPopupList(
    ...
    if (sortStandard == SortStandard.LIKES) {
      ...
      List<Popup> popupList =
          popupRepository.findPopupListByRegionAndLikes(region, normalizedDistrict);
  ...
  @Override
  public List<PopupResponseDto> getFilteredMapPopupList(
      String region,
      String district,
      Double latitude,
      Double longitude,
